...
var UserPointSharingComponent = /** @class */ (function () {
    function UserPointSharingComponent(services, router, toastr, vcr, loaderService, http) {
        ...
        this.report = new model_1.UserPointEarnedModel();
    ...
    UserPointSharingComponent = __decorate([
        core_1.Component({
            selector: "user-point",
            templateUrl: "./userpointsharing.component.html",
        }),
...
exports.UserPointSharingComponent = UserPointSharingComponent;
//# sourceMappingURL=userpointsharing.component.js.map